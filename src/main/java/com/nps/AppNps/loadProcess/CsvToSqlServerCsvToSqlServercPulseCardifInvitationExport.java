...
public class CsvToSqlServerCsvToSqlServercPulseCardifInvitationExport {
    ...
    private void loadProperties() {
        ...
        try (InputStream input = getClass().getClassLoader().getResourceAsStream("config.properties")) {
            ...
            inputFilePathwm_cPulseInsuranceCardifInvitationExport = properties.getProperty("inputFilePathwm_cPulseInsuranceCardifInvitationExport");
            tableNamecPulseInsuranceCardifInvitationExport = properties.getProperty("tableNamecPulseInsuranceCardifInvitationExport");
    ...
    public void convertCsvToSqlServer() {
        try (Connection connection = DriverManager.getConnection(jdbcUrl);
             CSVReader csvReader = new CSVReader(new FileReader(inputFilePathwm_cPulseInsuranceCardifInvitationExport))) {
    ...
    private String buildInsertionSql(String[] headers) {
        String sql = "INSERT INTO " + tableNamecPulseInsuranceCardifInvitationExport + " VALUES (";
