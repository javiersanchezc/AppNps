...
public class CsvToSqlServerWPulseInvitationsExport {
    ...
    private void loadProperties() {
        ...
        try (InputStream input = getClass().getClassLoader().getResourceAsStream("config.properties")) {
            ...
            inputFilePathwm_wm_invitations = properties.getProperty("inputFilePathwm_wm_invitations");
            tableNamewPulse_Invitation_Export = properties.getProperty("tableNamewPulse_Invitation_Export");
    ...
    public void convertCsvToSqlServer() {
        try (Connection connection = DriverManager.getConnection(jdbcUrl);
             CSVReader csvReader = new CSVReader(new FileReader(inputFilePathwm_wm_invitations))) {
    ...
    private String buildInsertionSql(String[] headers) {
        String sql = "INSERT INTO " + tableNamewPulse_Invitation_Export + " VALUES (";
